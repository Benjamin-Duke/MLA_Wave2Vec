...
if __name__ == '__main__':
    ...
    parser.add_argument('--pretrained_path', type=str, required=True, help='Path to pre-trained model checkpoint')
    ...
    parser.add_argument('--classifier_steps', type=int, default=10000, help='Number of steps to train only the classifier')
    parser.add_argument('--log_dir', type=str, default='finetuning_runs', help='Directory for tensorboard logs')
    parser.add_argument('--checkpoint_dir', type=str, default='finetuning_checkpoints', help='Directory for saving checkpoints')
